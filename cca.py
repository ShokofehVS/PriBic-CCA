...
class ChengChurchAlgorithm(BaseBiclusteringAlgorithm):
    ...
    def _single_node_deletion(self, in_0, in_1, len_row, msr_thr,t_shareMSR, t_shareEval, t_sdel, t_size):
        ...
        msr_0, msr_1, row_msr_0, row_msr_1, col_msr_0, col_msr_1 = (self._calculate_scores_del(in_0, in_1, len_row, num_col_0,t_size))
        ...
        if stop:
            ...
            while not stop:
                ...
                msr_0, msr_1, row_msr_0, row_msr_1, col_msr_0, col_msr_1 = \
                    (self._calculate_scores_del(in_0, in_1, len_row, num_col_0,t_size))
    ...
    def _multiple_node_deletion(self, in_0, in_1, msr_thr,t_shareMSR, t_shareEval, t_muldel, t_size):
        ...
        if stop:
            ...
            while not stop:
                ...
                fss_rs_rows_0, fss_rs_rows_1 = self.fss_evaluation_without_len(r2remove_con_0, r2remove_con_1, t_size)
    ...
    def _node_addition(self, bij_0, bij_1, in_0, in_1, total_len_row, len_col, t_shareMSR, t_shareEval, t_add,t_size):
        ...
        msr_0, msr_1, _, _, _, _ = (self._calculate_scores_del(bij_0, bij_1, total_len_row, len_col,t_size))
    ...
    def secMult_vector(self, share_00, share_01, share_10, share_11,t_size):
        ...
        with open('result_size.txt', 'w') as saveFile:
            saveFile.write(str(P0.hat_d_j) + "\n")
            saveFile.write(str(P0.hat_e_j) + "\n")
            saveFile.write(str(P1.hat_d_j) + "\n")
            saveFile.write(str(P1.hat_e_j) + "\n")
        t_size.append(os.path.getsize("result_size.txt"))
    ...
    def fss_evaluation(self, share_0, share_1, len, t_size):
    ...
    def fss_evaluation_without_len(self, share_0, share_1, t_size):
